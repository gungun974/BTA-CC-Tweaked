...
public class BlockModelCorrectVeryRotable<T extends BlockLogic> extends BlockModelGenericVeryRotatable<T> {
    public BlockModelCorrectVeryRotable(@NotNull Block<T> block, @NotNull StaticBlockModel staticModel) {
