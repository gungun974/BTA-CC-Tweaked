...
public class Terminal
{
    ...
    {
        cursorX = nbt.getInteger( "term_cursorX" );
        cursorY = nbt.getInteger( "term_cursorY" );
        cursorBlink = nbt.getBoolean( "term_cursorBlink" );
        cursorColour = nbt.getInteger( "term_textColour" );
        cursorBackgroundColour = nbt.getInteger( "term_bgColour" );
