...
//    public ContainerTurtle(int id, Player player, TurtleBrain turtle )
//    {
//        this( id,
//            p -> turtle.getOwner()
//                .stillValid( p ),
...
//    }
//
//    private ContainerTurtle( int id, Predicate<Player> canUse, IComputer computer, ComputerFamily family, Container playerInventory,
//                             Container inventory, PropertyDelegate properties )
//    {
