...
{
    private static final Int2ObjectMap<Consumer<PacketByteBuf>> packetReaders = new Int2ObjectOpenHashMap<>();
...
//        registerMainThread( 15, TerminalDimensionsClientMessage.class, TerminalDimensionsClientMessage::new );
    ...
    public static void receive( PacketByteBuf buffer )
    {
    ...
    public static void sendToPlayer(Player player, NetworkMessage packet )
    {
        ...
        //ComputerCraft.log.info("Send packet {}", encode(packet));
