...
public class MenuPocketComputer extends MenuAbstract {
    public static final int PLAYER_START_Y = 134;

    public ItemPocketComputer item;
    private final int inventorySlotsStart;
    private final int hotbarSlotsStart;

    public MenuPocketComputer(Container container, ItemPocketComputer item) {
        this.item = item;
        ...
        this.inventorySlotsStart = 0;
        this.hotbarSlotsStart = 27;
    }

    @Override
    public boolean stillValid(Player entityplayer) {
        return true;
        //return this.item.stillValid(entityplayer);
    }
